...
\begin{abstract}
    ...
    complex multivariate objects. The methodology to estimate them from
    the functional signal and to compare them is still in rapid progress.
    % What a shit sentence above!

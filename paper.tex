...
$\rho_{ab}$, $\rho_{bc}$ and $\rho_{ac}$.

% Rmk average of correlations will measure the sphericity of the
% distribution
...
\caption{Two different correlation matrix with the same average
correlation, but integration values that strongly differ.

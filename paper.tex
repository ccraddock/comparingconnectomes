...
Brain functional connectivity captures the synchronization of distant
neural systems via correlations in brain activity. Given that brain
...
mapping of regions recruited in tasks. However, while activation mapping
has a well-defined standard analysis framework that enables
statistically-controlled comparisons across subjects \cite{friston1995},
group-level analysis of functional connectivity is still offers many
...
simplified and synthetic representations: distributed functional networks
depicted by their spatial maps \cite{fox2005} or a connections linking
localized functional modules depicted as a graph \cite{bullmore2009}.
Here we focus on the latter: the functional connectome \cite{sporns2005}.

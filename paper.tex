...
for a gentle introduction to support vector machines.} (classification and regression) are popular
...
accuracy and model interpretation \cite{pereira2009}. One feature selection strategy is 

...
\begin{figure}
\includegraphics[width=.495\linewidth]{group_l21_prec_no_confounds.pdf}%
\hspace*{1pt}%
\includegraphics[width=.495\linewidth]{group_l21_prec_global_mean.pdf}%

\caption{Different choice of confound regressors --
...
% XXX: in the figures, the inserts must be commented.

% XXX: idea: use the same regions as in the Fransson/Marrelec paper on
% the role of the PCC
...
graphical-lasso ($\ell_1$-penalized maximum-likelihood estimator)
\cite{friedman2008} is a good general-purpose approach. In group studies,
...
(see Fig\,\ref{fig:icov}); however, unlike in a univariate situation, the

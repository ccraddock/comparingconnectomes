...
more sensitive to function inhomogeniety \cite{craddock2012} and exhibits worse
...
measures of connectivity, or any of the previously discussed summary metrics.  
%
...
cross-validation. Cross-validation iteratively seperates available data into a
subset used for training the classifier and a dataset for evaluating classifier
performance. Several strategies exist for performing cross-valdiaiton and the commonly
...
information exists in the connectome about a phenotypic variable, indentifying
...
tested in followon experiments better suited to elucidating their relationship

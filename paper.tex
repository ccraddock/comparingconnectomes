...
% CAMERON change cordes 2000 to Friston 1993
\cite{biswal1995,cordes2000}.
% CAMERON would probably include citation to connectome in next sentence.
...
as the inference of functional connectivity from (hemodynamic?, BOLD?) fluctuations 
% CAMERON the sentence "implies important specificities in the statical modeling"
% is a little odd
implies important specificities in the statistical modeling. While 
...
connected together by \emph{edges}. 
% CAMERON I would define nodes and edges here, I like the Varela definitions
% where a node represents a local network of cells, typically < 1 cm^3
% in volume in which synchronization is achieved via biochemical processes
...
% CAMERON what about all the other clustering people Flandin, Poline, Bellec, ...
...
% CAMERON I think that this reference to Fair should be Dosenbach
...
% CAMERON: cite Smith, Kivinimi, maybe Yeo
...
% CAMERON I would avoid using such statements, in my readings HO is much
% more popular, also the Talaraich Atlas is commonly used, I would include
% all of these
...
% CAMERON my paper directly shows the inadequacy of AAL, TT, HO and EZ for
% representing functional connectivity
...
% CAMERON I don't think that EPI was ever defined or even need be
...
% CAMERON = I think we should differentiate between signal extraction and
% signal cleaning, actually the cleaning is a seperate issue, that is independent
% of the regions or nodes.
...
% CAMERON it is important to regress movement and other stuff from 
% REST and TASK, just not done in task
...
% CAMERON WM and CSF are "negative controls" and represent thermal noise, 
% systematic variation due to multichannel head coils, cardiac and resp.
% smaller motions, physiological noise correction, spatial varying WM noise
% GLOBAL MEAN IS A HUGE CONTROVERSY
...
% CAMERON, this is just as important for task btw ...

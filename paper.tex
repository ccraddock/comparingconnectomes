...
the number of connections. Feature selection \cite{guyon2003} 
...
a ordinary linear regression. If features are appropriately standardized
prior to training, the magnitude of weights can be interpreted to reflect
the relative importance of the feature to the model, for instance the
corresponding edge in the connectome. However,
interpreting how the connections differs between classes or relates to a

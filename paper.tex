...
that lies in a network of strongly connected nodes, a large sub-network is
...
GV acknowledges funding from the NiConnect grant, as well as many
insightful discussions with Andreas Kleinschmidt on on-going activity and
Bertrand Thirion on statistical data processing.

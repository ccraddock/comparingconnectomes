...
capable of \emph{predicting} information from new unseen data
...
cross-validation. Cross-validation iteratively separates available data into a
...
not directly identify the connections that are most relevant to the prediction.  These problems can be somewhat mitigated  by
relying on previously described sparse inverse covariance estimation techniques to minimize
the number of connections. In addition, feature selection \cite{guyon2003} 
